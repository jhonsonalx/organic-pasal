                    ...
                    <div  className="col">
                        <div  className="product__details--info">
                            <form action="#">
                                ...
                                <p  className="product__details--info__desc mb-20">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                                Aut numquam ullam is recusandae laborum explicabo id sequi quisquam, 
                                ab sunt deleniti quidem ea animi facilis quod 
