                                            ...
                                            <div className="swiper-slided col-4" style={{ marginLeft: "10px", marginRight: "10px" }}>
                                                <div className="blog__items">
                                                    <div className="blog__items--thumbnail">
                                                        <Link className="blog__items--link" to='/blog'><img className="blog__items--img" src={`${baseURL}${blog.image}`} alt="blog-img" /> </Link>
                                                    </div>
                                                        ...
                                                        <div className="blog__items--meta">
                                                            <ul className="d-flex">
                                                                <li className="blog__items--meta__list">
                                                                    ...
                                                                    <span className="blog__items--meta__text">0 Comments</span>
                                                                </li>
                                                                <li className="blog__items--meta__list">
                                                                    <svg className="blog__items--meta__icon" xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15">
                                                                    ...
                                                                    <span className="blog__items--meta__text">{dateFormat(blog.created_on, "mmmm dS, yyyy")}</span>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <h3 className="blog__items--title"> <Link to='/blog'>{blog.title}</Link></h3>
                                                        <p className="blog__items--desc">{blog.metades}</p>
                                                        <Link className="blog__items--readmore" to='/blog'>Read more <svg className="blog__items--readmore__icon" xmlns="http://www.w3.org/2000/svg" width="6.2" height="6.2" viewBox="0 0 6.2 6.2">
