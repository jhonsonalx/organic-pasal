                            ...
                            <div className="footer__widget--inner">
                                ...
                                <ul className="footer__widget--social d-flex">
                                    <li className="footer__widget--social__list">
                                        <Link className="footer__widget--social__icon" target="_blank" to="https://www.facebook.com/">
                                    ...
                                    <li className="footer__widget--social__list">
                                        <Link className="footer__widget--social__icon" target="_blank" to="https://twitter.com/">
                                    ...
                                    <li className="footer__widget--social__list">
                                        <Link className="footer__widget--social__icon" target="_blank" to="https://www.instagram.com/">
                                    ...
                                    <li className="footer__widget--social__list">
                                        <Link className="footer__widget--social__icon" target="_blank" to="https://www.youtube.com/">
