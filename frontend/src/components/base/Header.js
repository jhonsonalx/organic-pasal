        ...
        <header className="header__section header__transparent">
                            ...
                            <ul className="d-flex">
                                ...
                                <li className="header__account--items">
                                    <Link className="header__account--btn minicart__open--btn" to="cart" data-offcanvas>
                                        ...
                                        <span className="items__count">{this.state.order.length !== 0 ? this.state.order.length : 0}</span> 
                                    </Link>
                                </li>
                                <li className="header__account--items d-none d-lg-block">
                                    <Link className="header__account--btn" to="/wishlist">
                                        ...
                                        <span className="items__count">{this.state.wishlist.length}</span> 
                                    </Link>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul className="d-flex">
                                ...
                                <li className="header__account--items">
                                    <Link className="header__account--btn minicart__open--btn" to="#" data-offcanvas>
                                        ...
                                        <span className="items__count">{this.state.order.length !== 0 ? this.state.order.items?.length : 0}</span> 
                                    </Link>
                                </li>
                            </ul>
                        </div>
                                ...
                                <ul className="offcanvas__sub_menu">
                                    <li className="offcanvas__sub_menu_li">
                                        ...
                                        <ul className="offcanvas__sub_menu">
                                            ...
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Shop Right Sidebar</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Shop Grid</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Shop Grid List</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Shop List</Link></li>
                                        </ul>
                                    </li>
                                    <li className="offcanvas__sub_menu_li">
                                        <Link to="#" className="offcanvas__sub_menu_item">Column Two</Link>
                                        <ul className="offcanvas__sub_menu">
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Product Details</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Video Product</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Variable Product</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Product Left Sidebar</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Product Gallery</Link></li>
                                        </ul>
                                    </li>
                                    <li className="offcanvas__sub_menu_li">
                                        ...
                                        <ul className="offcanvas__sub_menu">
                                            ...
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/my-account">My Account 2</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">404 Page</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/login">Login Page</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Faq Page</Link></li>
                                        </ul>
                                    </li>
                                    <li className="offcanvas__sub_menu_li">
                                        <Link to="#" className="offcanvas__sub_menu_item">Column Three</Link>
                                        <ul className="offcanvas__sub_menu">
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Compare Pages</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Checkout page</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Checkout Style 2</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Checkout Style 3</Link></li>
                                            <li className="offcanvas__sub_menu_li"><Link className="offcanvas__sub_menu_item" to="/">Checkout Style 4</Link></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
            ...
            <div className="offcanvas__stikcy--toolbar">
                <ul className="d-flex justify-content-between">
                    ...
                    <li className="offcanvas__stikcy--toolbar__list">
                        <Link className="offcanvas__stikcy--toolbar__btn minicart__open--btn" to="/cart" data-offcanvas>
                            <span className="offcanvas__stikcy--toolbar__icon"> 
